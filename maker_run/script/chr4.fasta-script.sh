...
#$ -cwd
#$ -N chr4.fasta
#$ -o /grid/ware/data_norepl/bwang/RP125/maker_run/output/chr4.fasta-out.txt
#$ -e /grid/ware/data_norepl/bwang/RP125/maker_run/error/chr4.fasta-err.txt
#$ -terse
###$ -l virtual_free=3.8G
#$ -l m_mem_free=3.8G
###$ –l h_vmem=3.8G
...
mpiexec -n 32 maker -R -g /grid/ware/data_norepl/bwang/RP125/masked2.genome/chr4.fasta -t 10 -TMP $TMPDIR -fix_nucleotides || { echo JOB_STATUS=ERROR 1>&2; exit; }
