...
#$ -cwd
#$ -N luj-chr4.fasta
#$ -o /grid/ware/data_norepl/kapeel/MaizeCode/Ti11/maker/maker_run/output/chr4.fasta-out.txt
#$ -e /grid/ware/data_norepl/kapeel/MaizeCode/Ti11/maker/maker_run/error/chr4.fasta-err.txt
#$ -terse
###$ -l virtual_free=3.8G
#$ -l m_mem_free=3.8G
###$ –l h_vmem=3.8G
...
mpiexec -n 32 maker -R -g /grid/ware/data_norepl/luj/data/MaizeCode/Ti11/masked/chromosome_fasta/chr4.fasta -t 10 -TMP $TMPDIR -fix_nucleotides || { echo JOB_STATUS=ERROR 1>&2; exit; }
